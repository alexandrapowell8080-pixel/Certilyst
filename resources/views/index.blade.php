...
<body>
    ...
    <section class="hero-section">
        <div class="hero-background">
            <video autoplay muted loop playsinline preload="auto" class="hero-video"
                ...
                <source src="https://videos.pexels.com/video-files/7683392/7683392-hd_1920_1080_30fps.mp4"
            ...
            <div class="hero-grid">
                ...
                <div class="hero-content">
                    ...
                    <p class="hero-description">
                        Certilyst gives learners realistic exam simulations, detailed rationales, performance analytics,
                        adaptive study paths, and expertly curated certification prep systems.
                    </p>
                    ...
                    <div class="button-group">
                        ...
                        <a href ="{{ route('library') }}" class="btn btn-glass">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-mr">
                    ...
                    <div class="stats-group">
                        <div class="stat-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon text-purple">
                        ...
                        <div class="stat-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon text-amber fill-amber">
                                <path
                ...
                <div class="hero-visuals">
                    <div class="visuals-wrapper">
                        ...
                        <div class="glass-card card-readiness animate-float">
                            <div class="card-header">
                                <div class="icon-box gradient-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" class="icon text-white">
                                ...
                                <div>
                                    <p class="text-sm  ">Exam Readiness</p>
                            ...
                            <p class="text-xs  mt-2">You're almost ready to pass!</p>
                        </div>
                        ...
                        <div class="glass-card card-trend animate-float-slow" style="animation-delay: 1s;">
                            <div class="card-header-small">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="icon text-primary">
                            ...
                            <p class="text-xs text-green mt-2 flex-center"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="icon icon-sm">
                        ...
                        <div class="glass-card card-sessions animate-float" style="animation-delay: 2s;">
                            ...
                            <div class="list-item">
                                <span class="text-xs ">NCLEX Practice #4</span>
                                <span class="text-xs text-bold text-green">82%</span>
                            </div>
                            <div class="list-item">
                                <span class="text-xs ">Pharmacology Quiz</span>
                                <span class="text-xs text-bold text-amber">74%</span>
                            </div>
                            <div class="list-item">
                                <span class="text-xs ">CompTIA Sec+ Mock</span>
                        ...
                        <div class="glass-card card-prediction animate-float-slow" style="animation-delay: 0.5s;">
                            <div class="card-header-small mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="icon text-accent">
                                    <path
                            ...
                            <div class="circular-progress">
                                <svg viewBox="0 0 36 36">
                                    <path
                                        ...
                                        fill="none" stroke="hsl(260, 30%, 92%)" stroke-width="3"></path>
                                    <path
                                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                                        fill="none" stroke="url(#grad)" stroke-width="3"
                                        stroke-dasharray="92, 100" stroke-linecap="round"></path>
                                    <defs>
                            ...
                            <p class="text-xs  text-center mt-1">Likely to pass</p>
                        </div>
    ...
    <section class="stats-banner">
        <div class="stats-grid">
            <div class="stats-block">
                <div class="stats-icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <path d="M0 16C0 13.5 4.5 12 10 12C15.5 12 20 13.5 20 16" stroke="currentColor"
            ...
            <div class="stats-block">
                <div class="stats-icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M10 18L12.5 12L18 10L12.5 8L10 2L7.5 8L2 10L7.5 12L10 18Z" stroke="currentColor"
            ...
            <div class="stats-block">
                <div class="stats-icon">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M3 16V8H6V16H3Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M7 16V4H10V16H7Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M11 16V10H14V16H11Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M15 16V2H18V16H15Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </div>
    ...
    <section class="certification-paths">
        <div class="section-container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Access expertly built practice systems across the most in-demand
                    certification categories.</p>
            </div>
            <div class="paths-grid">
                <div class="path-card">
                    <div class="path-icon purple"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path
                                d="M10 18C10 18 2 13 2 8C2 5 4.5 2 7.5 2C9 2 10 3 10 3C10 3 11 2 12.5 2C15.5 2 18 5 18 8C18 13 10 18 10 18Z"
                                stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                    ...
                    <div class="path-footer"><span class="path-count">48 practice tests</span><a
                            href="{{ route('library') }}#nursing" class="path-link">Explore →</a></div>
                </div>
                <div class="path-card">
                    <div class="path-icon pink"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M16 4V16H4V4H16Z" stroke="currentColor" stroke-width="1.5"
                    ...
                    <div class="path-footer"><span class="path-count">36 practice tests</span><a
                            href="{{ route('library') }}#realestate" class="path-link">Explore →</a></div>
                </div>
                <div class="path-card">
                    <div class="path-icon blue"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M10 18C10 18 18 12 18 7C18 4.5 16 2 10 2C4 2 2 4.5 2 7C2 12 10 18 10 18Z"
                                stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                            <path
                    ...
                    <div class="path-footer"><span class="path-count">28 practice tests</span><a
                            href="{{ route('library') }}#insurance" class="path-link">Explore →</a></div>
                </div>
                <div class="path-card">
                    <div class="path-icon green"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path
                                d="M16 6V14C16 15.1046 15.1046 16 14 16H6C4.89543 16 4 15.1046 4 14V6C4 4.89543 4.89543 4 6 4H14C15.1046 4 16 4.89543 16 6Z"
                    ...
                    <div class="path-footer"><span class="path-count">52 practice tests<a
                                href="{{ route('library') }}#it" class="path-link">Explore →</a></div>
                </div>
                <div class="path-card">
                    <div class="path-icon orange"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M16 14V16H4V14H16Z" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12 10V14H8V10H12Z" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M14 6V10H6V6H14Z" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg></div>
                    <h3 class="path-title">Project Management</h3>
                    <p class="path-desc">PMP, CAPM, Agile, and Scrum certification prep.</p>
                    <div class="path-footer"><span class="path-count">24 practice tests</span><a
                            href="{{ route('library') }}#project" class="path-link">Explore →</a></div>
                </div>
                <div class="path-card">
                    <div class="path-icon teal"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M4 16L16 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M4 4V8H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M16 16V12H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg></div>
                    <h3 class="path-title">HS Equivalency & Admissions</h3>
                    <p class="path-desc">GED, HiSET, TEAS, and entrance exam practice.</p>
                    <div class="path-footer"><span class="path-count">32 practice tests</span><a
                            href="{{ route('library') }}#hs" class="path-link">Explore →</a></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="how-it-works-roadmap">
        <div class="section-container">
            ...
            <div class="roadmap-wrapper">
                <svg viewBox="0 0 1200 350" xmlns="http://www.w3.org/2000/svg" class="roadmap-svg"
                    preserveAspectRatio="xMidYMid meet" id="roadmapSvg">
                    <defs>
                        ...
                        <filter id="roadShadow" x="-20%" y="-20%" width="140%" height="140%">
                            <feDropShadow dx="0" dy="8" stdDeviation="12" flood-color="#000"
                                flood-opacity="0.2" />
                        </filter>
                        ...
                        <linearGradient id="carGradient" x1="0%" y1="0%" x2="100%"
                            y2="0%">
                    ...
                    <path id="roadPath"
                        d="M 80 250 C 180 250, 230 200, 330 200 C 430 200, 480 250, 580 250 C 680 250, 730 120, 830 120 C 930 120, 980 220, 1080 220 C 1130 220, 1160 190, 1180 180"
                        fill="none" stroke="url(#roadGrad)" stroke-width="65" stroke-linecap="round"
                        stroke-linejoin="round" filter="url(#roadShadow)" />

                    <path id="centerLinePath"
                        d="M 80 250 C 180 250, 230 200, 330 200 C 430 200, 480 250, 580 250 C 680 250, 730 120, 830 120 C 930 120, 980 220, 1080 220 C 1130 220, 1160 190, 1180 180"
                        fill="none" stroke="#fbbf24" stroke-width="4" stroke-dasharray="15 12"
                        stroke-linecap="round" stroke-linejoin="round" opacity="0.9" />

                    <g transform="translate(50, 230)">
                        <rect x="0" y="0" width="60" height="40" rx="8" fill="#10b981"
                            filter="url(#roadShadow)" />
                        <text x="30" y="26" text-anchor="middle" fill="white" font-size="13" font-weight="800"
                            font-family="Inter, sans-serif">START</text>
                    </g>

                    <g transform="translate(1150, 160)">
                        <rect x="0" y="0" width="60" height="40" rx="8" fill="#ef4444"
                            filter="url(#roadShadow)" />
                        <text x="30" y="26" text-anchor="middle" fill="white" font-size="12" font-weight="800"
                            font-family="Inter, sans-serif">FINISH</text>
                    </g>

                    <g transform="translate(310, 170)" class="pin-marker" data-step="1">
                        <path
                            d="M 0,-40 C -14,-40 -26,-28 -26,-12 C -26,8 0,30 0,30 C 0,30 26,8 26,-12 C 26,-28 14,-40 0,-40 Z"
                            fill="url(#pinPurple)" stroke="white" stroke-width="2.5" />
                        <circle cx="0" cy="-12" r="8" fill="white" />
                        <text x="0" y="-7" text-anchor="middle" fill="#7c3aed" font-size="14" font-weight="800"
                            font-family="Inter, sans-serif">1</text>
                    </g>

                    <g transform="translate(560, 220)" class="pin-marker" data-step="2">
                        <path
                            d="M 0,-40 C -14,-40 -26,-28 -26,-12 C -26,8 0,30 0,30 C 0,30 26,8 26,-12 C 26,-28 14,-40 0,-40 Z"
                            fill="url(#pinGreen)" stroke="white" stroke-width="2.5" />
                        <circle cx="0" cy="-12" r="8" fill="white" />
                        <text x="0" y="-7" text-anchor="middle" fill="#16a34a" font-size="14" font-weight="800"
                            font-family="Inter, sans-serif">2</text>
                    </g>

                    <g transform="translate(810, 90)" class="pin-marker" data-step="3">
                        <path
                            d="M 0,-40 C -14,-40 -26,-28 -26,-12 C -26,8 0,30 0,30 C 0,30 26,8 26,-12 C 26,-28 14,-40 0,-40 Z"
                            fill="url(#pinBlue)" stroke="white" stroke-width="2.5" />
                        <circle cx="0" cy="-12" r="8" fill="white" />
                        <text x="0" y="-7" text-anchor="middle" fill="#2563eb" font-size="14" font-weight="800"
                            font-family="Inter, sans-serif">3</text>
                    </g>

                    <g transform="translate(1110, 190)" class="pin-marker" data-step="4">
                        <path
                            d="M 0,-40 C -14,-40 -26,-28 -26,-12 C -26,8 0,30 0,30 C 0,30 26,8 26,-12 C 26,-28 14,-40 0,-40 Z"
                            fill="url(#pinPink)" stroke="white" stroke-width="2.5" />
                        <circle cx="0" cy="-12" r="8" fill="white" />
                        <text x="0" y="-7" text-anchor="middle" fill="#db2777" font-size="14" font-weight="800"
                            font-family="Inter, sans-serif">4</text>
                    </g>

                    <g id="animatedCar" transform="translate(80, 220)">
                        <rect x="-18" y="-12" width="36" height="24" rx="6" fill="url(#carGradient)"
                            stroke="#92400e" stroke-width="2" />
                        <rect x="-12" y="-18" width="24" height="12" rx="4" fill="#fbbf24"
                            stroke="#92400e" stroke-width="2" />
                        <circle cx="-10" cy="12" r="5" fill="#1e293b" />
                        <circle cx="10" cy="12" r="5" fill="#1e293b" />
                        <circle cx="16" cy="-6" r="3" fill="#fef3c7" />
                        <circle cx="16" cy="2" r="3" fill="#fef3c7" />
                        <rect x="-8" y="-15" width="8" height="6" rx="2" fill="#dbeafe"
                            opacity="0.8" />
                        <rect x="2" y="-15" width="8" height="6" rx="2" fill="#dbeafe"
                            opacity="0.8" />
                    </g>
                </svg>
            </div>
                    ...
                    <div class="step-icon-wrapper pink">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
                            ...
                            <polygon
                                ...
                                fill="#fbbf24" stroke="none"></polygon>
                        </svg>
                    </div>
                    <h3>Pass</h3>
        ...
        <div class="section-container">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p class="feature-desc">Simulate real exam conditions with countdown timers and structured question
                        sets.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 20 20"
                ...
                <div class="feature-card">
                    <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path d="M3 3V17H17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M7 11L10 8L13 11L17 7" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg></div>
                ...
                <div class="feature-card">
                    <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 20 20"
                            ...
                            <rect x="3" y="5" width="14" height="10" rx="2" stroke="currentColor"
                                stroke-width="1.5" />
                            <path d="M7 15V17M13 15V17" stroke="currentColor" stroke-width="1.5"
                                stroke-linecap="round" />
                        </svg></div>
        ...
        <div class="section-container">
            <div class="highlight-block">
                <div class="highlight-text">
                    ...
                    <p>Mirror the exact pressure, timing, and structure of real exams. Our timed practice tests
                        replicate certification conditions so you walk in fully prepared.</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon"><svg width="24" height="24" viewBox="0 0 24 24"
                            fill="none">
                            <path
                    ...
                    <div class="highlight-stats">
                        <div class="h-stat"><span class="h-val">99%</span><span class="h-lbl">Exam accuracy</span>
                        </div>
                        <div class="h-stat"><span class="h-val">8+</span><span class="h-lbl">Question types</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="highlight-block reverse">
                <div class="highlight-text">
                    ...
                    <p>Domain-level reporting for weak area identification. Visualize score trends across practice
                        sessions and pinpoint the exact topics that need more work.</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon"><svg width="24" height="24" viewBox="0 0 24 24"
                            fill="none">
                            <path d="M3 3V21H21" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M7 14L11 10L15 14L21 8" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg></div>
                    <div class="highlight-stats">
                        <div class="h-stat"><span class="h-val">25+</span><span class="h-lbl">Data points
                                tracked</span></div>
                        <div class="h-stat"><span class="h-val">6</span><span class="h-lbl">Report types</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="highlight-block">
                <div class="highlight-text">
                    ...
                    <p>Adaptive recommendations based on missed questions. Our system learns from your performance and
                        creates a custom roadmap to exam readiness.</p>
                </div>
                <div class="highlight-card">
                    <div class="highlight-icon"><svg width="24" height="24" viewBox="0 0 24 24"
                            fill="none">
                    ...
                    <div class="highlight-stats">
                        <div class="h-stat"><span class="h-val">40%</span><span class="h-lbl">Avg. time
                                saved</span></div>
                        <div class="h-stat"><span class="h-val">3</span><span class="h-lbl">Adaptive modes</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section-container">
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-quote">"Certilyst was the only resource that made me feel truly prepared. The
                        realistic simulations and detailed rationales were game-changers. Passed on my first attempt!"
                    </p>
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-quote">"I studied for just three weeks with Certilyst and passed my real
                        estate licensing exam with a 94%. The practice tests were spot-on accurate."</p>
                    <div class="testimonial-divider"></div>
                    <div class="testimonial-author">
                ...
                <div class="testimonial-card">
                    <div class="stars">★★★★★</div>
                    <p class="testimonial-quote">"The performance analytics helped me identify my weak domains
                        instantly. I focused my energy exactly where it mattered. Highly recommended for IT certs."</p>
                    <div class="testimonial-divider"></div>
                    <div class="testimonial-author">
    ...
    <section class="faq-section">
        <div class="section-container">
            ...
            <div class="faq-list">
                <div class="faq-item">
                    <button class="faq-question">How many exams are included? <span
                            class="faq-icon">+</span></button>
                    <div class="faq-answer">
                        <p>We offer practice exams for over 200 certifications across healthcare, IT, real estate,
                            project management, and more. New exams are added monthly.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <button class="faq-question">Are explanations included? <span class="faq-icon">+</span></button>
                    <div class="faq-answer">
                        <p>Yes. Every question includes a detailed rationale explaining why the correct answer is right
                            and why the distractors are wrong.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <button class="faq-question">Can I study on mobile? <span class="faq-icon">+</span></button>
                    <div class="faq-answer">
                        <p>Absolutely. Certilyst is fully responsive and optimized for mobile, tablet, and desktop.
                            Study anywhere, anytime.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <button class="faq-question">Is progress saved automatically? <span
                            class="faq-icon">+</span></button>
                    <div class="faq-answer">
                        <p>Yes. Your scores, bookmarks, and study history sync automatically across all your devices.
                        </p>
                    </div>
                </div>
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>Yes. You can choose between timed exam simulations that mirror real test conditions, or
                            practice mode with no time limits.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <button class="faq-question">Are new exams added regularly? <span
                            class="faq-icon">+</span></button>
                    <div class="faq-answer">
                        <p>Definitely. We update our library monthly based on the latest exam blueprints and learner
                            requests.</p>
                    </div>
                </div>
            </div>
